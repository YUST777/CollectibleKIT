...
import { ArrowLeft, Info, Eye, Loader2 } from 'lucide-react';
    ...
    if (!camp || !session) {
        return (
            <div className="min-h-screen bg-black text-white p-8 flex flex-col items-center justify-center">
                ...
                <Link href="/dashboard/sessions" className="text-[#d59928] hover:underline">Return to Sessions</Link>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-black text-white font-sans">
            <div className="sticky top-0 z-50 bg-black/80 backdrop-blur-xl border-b border-white/10">
                <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
                    <Link href={`/dashboard/sessions/${campSlug}`} className="flex items-center gap-2 text-white/70 hover:text-white transition">
