...
const SlideStatSplit = ({ slide }: any) => (
...
const SlideStatHighlight = ({ slide }: any) => (
...
const SlideSummary = ({ slide, onReplay }: { slide: any; onReplay: () => void }) => (
