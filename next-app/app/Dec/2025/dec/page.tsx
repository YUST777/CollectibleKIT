...
import { ChevronRight, Share2, Code, Zap, Globe, Users, Trophy, PlayCircle, Facebook, Linkedin, Calendar } from 'lucide-react';
            ...
            <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex-1 flex flex-col justify-center px-6 md:px-10 pb-16 md:pb-20">
                    ...
                    <p className="text-white/80 text-sm mb-8 leading-relaxed">
                        We developed <span className="text-[#E8C15A]">icpchue.xyz</span> entirely from scratch, skipping ready-made tools.
                    </p>
