                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                    <div className="col-span-2 md:col-span-1 text-center md:text-left">
                        ...
                        <div className="flex justify-center md:justify-start gap-4">
                            <a href="https://www.facebook.com/icpchue/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[#d59928] transition-colors"><Facebook size={20} /></a>
                            <a href="https://www.linkedin.com/in/icpchue/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[#d59928] transition-colors"><Linkedin size={20} /></a>
                            <a href="https://x.com/ICPCHUE" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[#d59928] transition-colors"><Twitter size={20} /></a>
                        </div>
                    </div>
