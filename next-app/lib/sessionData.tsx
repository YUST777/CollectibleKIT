...
export const camps: Camp[] = [
    ...
    },
    {
        ...
        sessions: [
            ...
            },
            {
                ...
                tag: 'Programming 1',
                title: 'Exam Training',
                desc: 'Coming soon today at live 1/1/2026',
                description: 'Live exam training session.',
                thumbnail: '/images/lessons/pro1/examtraining.webp',
                videoId: '',
                content: (
                    <div className="flex flex-col items-center justify-center p-12 text-center bg-[#111] rounded-2xl border border-white/10">
                        <div className="w-16 h-16 bg-[#d59928]/10 rounded-full flex items-center justify-center mb-4">
                            <Loader2 className="w-8 h-8 text-[#d59928] animate-spin" />
                        </div>
                        <h3 className="text-xl font-bold text-white mb-2">Coming Soon</h3>
                        <p className="text-white/60">This session will be live on 1/1/2026.</p>
                    </div>
                )
            }
        ]
    ...
    },
    {
        ...
        description: "Learn how to use the ICPC HUE training platform effectively.",
        image: '/images/lessons/pro1/howtologin.webp',
        publicVisible: true,
        ...
        sessions: [
            {
                ...
                displayNumber: '01',
                tag: 'Guide',
                title: 'How to Join & Login',
                desc: 'Comprehensive guide to setting up your account.',
                description: 'Comprehensive guide to setting up your account.',
                thumbnail: '/images/lessons/tutorial/login.webp', // Placeholder
                videoId: '15zmRD-Sl7vzPS-bcj9sdhFG-rncDYpma',
                content: (
                    <div className="space-y-12 text-white/90">
                        <section className="space-y-6">
