  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'slide-in-from-bottom-full': 'slideInFromBottomFull 0.3s cubic-bezier(0.16, 1, 0.3, 1)',
        'slide-out-to-bottom-full': 'slideOutToBottomFull 0.2s ease-in',
        'fade-in-0': 'fadeIn0 0.2s ease-out',
        'fade-out-0': 'fadeOut0 0.2s ease-in',
      },
      keyframes: {
        fadeIn: {
          '0%': { opacity: '0' },
