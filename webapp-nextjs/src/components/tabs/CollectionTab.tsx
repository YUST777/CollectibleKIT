...
export const CollectionTab: React.FC = () => {
  ...
  return (
    <div className="space-y-6 py-4 animate-fade-in">
      ...
      <div className="flex items-center justify-center px-4">
        <div className="flex items-center gap-1.5 bg-gray-800/50 rounded-2xl px-3 py-2 border border-gray-700/50 backdrop-blur-sm shadow-lg">
          {/* Grid Size Selector */}
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              className="bg-white/10 text-xs text-white rounded-xl px-2.5 py-1 focus:outline-none focus:ring-1 focus:ring-blue-500/50 cursor-pointer hover:bg-white/15 transition-all border border-transparent hover:border-white/20"
            >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gray-700/30 hover:bg-gray-700/50 text-gray-300 text-xs font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed border border-transparent hover:border-gray-600/30"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium transition-all shadow-md disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-purple-600 hover:bg-purple-700 text-white text-xs font-medium transition-all shadow-md disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg"
          >
