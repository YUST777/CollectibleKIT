        ...
        <div className="flex items-center gap-1.5 backdrop-blur-xl bg-[#1c1d1f]/40 rounded-xl px-2 py-1.5 border border-gray-700/50 shadow-lg shadow-black/20">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              className="bg-white/10 text-xs text-white rounded-md px-2 py-1 focus:outline-none focus:ring-1 focus:ring-blue-500/50 cursor-pointer hover:bg-white/15 transition-all border border-transparent hover:border-white/20"
            >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-gray-700/30 hover:bg-gray-700/50 text-gray-300 text-xs font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed border border-transparent hover:border-gray-600/30"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium transition-all shadow-md disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg"
          >
